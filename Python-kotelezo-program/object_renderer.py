...
class ObjectRenderer:
    ...
    def __init__(self, game):
        ...
        self.game_done_image = self.get_texture('resources/textures/'
                                                'game_done.png', s.RES)
        self.start_screen = self.get_texture('resources/textures/'
                                             'start.png', s.RES)
    ...
    def start(self):
        """Játék elején lévő képet rajzoló függvény"""
    ...
    def game_done(self):
        """Játék teljesítést követő képet rajzoló függvény"""

        self.screen.blit(self.game_done_image, (0, 0))
